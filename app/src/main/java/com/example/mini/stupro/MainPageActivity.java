...
public class MainPageActivity extends AppCompatActivity
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    speakToast("Searching for mechanic");
    ...
    private void getMechPos() {
        ...
        final String cust_id = FirebaseAuth.getInstance().getCurrentUser().getUid();
        final DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Mechanic").child(mechId).child("custAllocId");
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists())
                {
                    Toast.makeText(MainPageActivity.this, "Mechanic cancelled the request...", Toast.LENGTH_SHORT).show();
                    speakToast("Mechanic cancelled the request");
                    mechMark.remove();
                    reqcan=true;
                    DatabaseReference reg = FirebaseDatabase.getInstance().getReference().child("RequestedCustomers").child(cust_id);
                    reg.removeValue();
                }
                else if(disbw<100)
                {
                    Toast.makeText(MainPageActivity.this, "Mechanic work is over", Toast.LENGTH_SHORT).show();
                    speakToast("Mechanic work is over");
                }
            }
